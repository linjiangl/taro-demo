    ...
    <view class="cart">
      <view v-for="item in products" :key="item.id">
        <nut-row type="flex" wrap="nowrap">
          <nut-col :span="2">
            <nut-checkbox v-model="item.checked" icon-size="12"></nut-checkbox>
          </nut-col>
          <nut-col :span="20">
            <nut-card
              :img-url="item.imgUrl"
  ...
  setup() {
    const data = reactive({
      products: [
        ...
        {
          id: 2,
          imgUrl: 'https://m.360buyimg.com/n2/jfs/t1/35828/26/5078/324781/5cbea100Eb22bb637/4d2d5e3bcd86fba4.jpg',
          title: '数码相机 索尼相机',
          price: '1388',
          vipPrice: '1378',
          shopDesc: '自营',
